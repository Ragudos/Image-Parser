...
const MIN_LOWERCASE_CHARACTER_ASCII_CODE = 65;
const MAX_LOWERCASE_CHARACTER_ASCII_CODE = 90;
const MIN_UPPERCASE_CHARACTER_ASCII_CODE = 97;
const MAX_UPPERCASE_CHARACTER_ASCII_CODE = 122;
